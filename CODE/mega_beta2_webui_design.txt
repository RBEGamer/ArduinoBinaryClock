...
webui_client.println("<br /><br />");      
 ...
 if(nthen == 1){  webui_client.println(" <a href=\'/?nthen_toggle\'\' color='green'><font color='#FF0000'>ENABLE NIGHMODE</font></a>");}else{webui_client.println(" <a href=\'/?nthen_toggle\'\'><font color='#00FF00'>DISABLE NIGHTMODE</font></a>");}
