...
void COLORCmd(WebServer &server, WebServer::ConnectionType type, char *, bool)
{
...
if (type != WebServer::HEAD)
  ...
  /* if we're handling a GET or POST, we can output our data here.
    ...
    P(mainheader) = "<html><head>"
"<meta http-equiv='Content-Type' content='text/html; charset=windows-1252'>"
"<title>NERD CLOCK ADMIN PAGE -> COLOR SETTINGS</title>"
"<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />"
"<meta name='viewport' content='width=device-width, initial-scale=1.0' />"
"<meta name='apple-mobile-web-app-capable' content='yes' />"
"<meta name='apple-mobile-web-app-status-bar-style' content='black-translucent' />"
...
if(use_webui == 1){
  char buff[64];
  int len = 64;
   webserver.processConnection(); // process incoming connections one at a time forever
