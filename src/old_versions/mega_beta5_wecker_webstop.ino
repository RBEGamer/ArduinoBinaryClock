    ...
    while (webui_client.connected()) {
      if (webui_client.available()) {
        ...
        if (c == '\n') {
          ...
          if(webui_auto_refresh == 1){webui_client.println("<meta http-equiv='refresh' content='7'>");}
          webui_client.println("<link rel='stylesheet' type='text/css' href='http://homeautocss.net84.net/a.css' />");
          webui_client.println("<style type='text/css'>body{ background-image:url(http://www.designbolts.com/wp-content/uploads/2012/12/Skeletal-Weave-White-Tileable-pattern-for-website-background.jpg);background-repeat:repeat; }</style>");
