...
const int software_version = 2500;
int alarm_en = 0;
int alarm_h = 0;
int alarm_m = 0;
int alarm_process = 0;
...
server<<"   <form id='gettime' name='gettime' action=''  method='post'>";
server<<"<input type='hidden' id='getntp' name='getntp' value='1'>";
server<<"<input type='submit' value='UPDATE TIME VIA NTP-SERVER' />";
server<<"</form>";

server<<"   <form id='gettime' name='gettime' action=''  method='post'>";
server<<"<input type='hidden' id='getgps' name='getgps' value='1'>";
server<<"<input type='submit' value='UPDATE TIME VIA GPS' />";
server<<"</form>";
//_----------------------------------
      server.printP(page_end);  
 }
