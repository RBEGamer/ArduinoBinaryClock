...
const int software_version = 10050;
int alarm_en = 0;
int alarm_h = 0;
int alarm_m = 0;
int alarm_process = 0;
    ...
    while (webui_client.connected()) {
      if (webui_client.available()) {
        ...
        if (c == '\n') {
          ...
          webui_client.print("<HEAD>");
          webui_client.print("<meta name='apple-mobile-web-app-capable' content='yes' />");
          webui_client.print("<meta name='apple-mobile-web-app-status-bar-style' content='black-translucent' />");
          if(webui_auto_refresh == 1){webui_client.print("<meta http-equiv='refresh' content='7'>");}
          webui_client.print("<link rel='stylesheet' type='text/css' href='http://homeautocss.net84.net/a.css' />");
          webui_client.print("<style type='text/css'>body{ background-image:url(http://www.designbolts.com/wp-content/uploads/2012/12/Skeletal-Weave-White-Tileable-pattern-for-website-background.jpg);background-repeat:repeat; }</style>");

          webui_client.print("<TITLE>CLOCK CONTROL</TITLE>");
          webui_client.print("</HEAD>");
          webui_client.print("<BODY>");
          webui_client.print("<H1>CLOCK CONTROL</H1>");
          webui_client.print("<hr />");
          webui_client.println("<br />");
         
         
         webui_client.println("<h2> Current Time : ");
         
         if(hour < 10){webui_client.println("0");}webui_client.println(hour);webui_client.println(":");
         if(minute < 10){webui_client.println("0");}webui_client.println(minute);webui_client.println(":");
         if(second < 10){webui_client.println("0");}webui_client.println(second);
         webui_client.println("</h2> <a href=\'/?update_time\'\' color='green'>Update time via NPT-Server</a>");
     
     webui_client.print("<br />");   
    webui_client.print("<br />");   
   webui_client.print("<br />");    
     webui_client.println("<br />"); 
       if(alarm_en == 1 && alarm_state == 1){  webui_client.println("</h2> <a href=\'/?stop_alarm\'\' color='green'>STOP ALARM</a>");     
     webui_client.print("<br />");    
     webui_client.print("<br />"); 
     webui_client.println("<br />"); 
       }
  webui_client.print("<hr />");  
webui_client.println("<H2>SET CURRENT LED-MODE [green = active]</H2> ");
...
webui_client.println("<hr />");
 webui_client.println("<H2>SETTINGS </H2> ");
            webui_client.print("<br />"); webui_client.print("<br />");
 if(nthen == 1){  webui_client.println(" <a href=\'/?nthen_toggle\'\' color='green'><font color='#FF0000'>DISABLE NIGHMODE</font></a>");}else{webui_client.println(" <a href=\'/?nthen_toggle\'\'><font color='#00FF00'>ENABLE NIGHTMODE</font></a>");}

 webui_client.print("<br />");    
    webui_client.print("<br />");   
   
if(webui_auto_refresh == 1){  webui_client.println(" <a href=\'/?auto_refresh_toggle\'\' color='green'><font color='#FF0000'>DISABLE AUTO-REFRESH</font></a>");}else{webui_client.println(" <a href=\'/?auto_refresh_toggle\'\'><font color='#00FF00'>ENABLE AUTO-REFRESH [RELOAD THIS PAGE AFTER PRESSING 'ENABLE']</font></a>");}


if(alarm_button_enable == 1){  webui_client.println(" <a href=\'/?toggle_alarmbtn\'\' color='green'><font color='#FF0000'>DISABLE ALARM BUTTON</font></a>");}else{webui_client.println(" <a href=\'/?toggle_alarmbtn\'\'><font color='#00FF00'>ENABLE ALARM BUTTON</font></a>");}

 webui_client.print("<br />");    
    webui_client.print("<br />");   
  
if(enable_dhcp == 1){  webui_client.println(" <a href=\'/?toggle_dhcp\'\' color='green'><font color='#FF0000'>DISABLE DHCP AND USE ALTERNATIVE NETOWRK CONFIGURATION [REQUIRE REBOOT]</font></a>");}else{webui_client.println(" <a href=\'/?toggle_dhcp\'\'><font color='#00FF00'>ENABLE DHCP [REQUIRE REBOOT]</font></a>");}

 webui_client.print("<br />");    
    webui_client.print("<br />");   
    webui_client.println("<br />");
if(alarm_en == 1){  webui_client.println(" <a href=\'/?toggle_alarm\'\' color='green'><font color='#FF0000'>DISABLE ALARM</font></a>");}else{webui_client.println(" <a href=\'/?toggle_alarm\'\'><font color='#00FF00'>ENABLE ALARM</font></a>");}


 webui_client.print("<br />");
  webui_client.print("<br />");
   webui_client.println("<br />");
  webui_client.println("<hr />");webui_client.println("<H2>ADVANCED SETTINGS</H2> ");
 
    webui_client.println("<form id='settings' name='settings' action=''>");
      
   webui_client.print("<label for='zeitverschiebung'>TIMEZONE </label>");webui_client.println("<input type='text' id='zeitverschiebung' name='zz' placeholder='0-23' value='");webui_client.print( zeitverschiebung);webui_client.println( "' />");
        webui_client.print("<br />");
       webui_client.print("<br />");
   
 
        webui_client.print("<label for='alarm_h'>ALARM HOUR </label>");webui_client.println("<input type='text' id='alarm_h' name='alarm_h' placeholder='0-23' value='");webui_client.print( alarm_h);webui_client.println( "' />");
        webui_client.println("<br />");
         webui_client.print("<label for='alarm_h'>ALARM MINUTE </label>");webui_client.println("<input type='text' id='alarm_m' name='alarm_m' placeholder='0-23' value='");webui_client.print( alarm_m);webui_client.println( "' />");
        webui_client.print("<br />");
       webui_client.print("<br />");
  
       
       
        webui_client.print("<label for='nth'>NIGHTMODE START MODE </label>");webui_client.println("<input type='text' id='nth' name='nth' placeholder='0-23' value='");webui_client.print( nth);webui_client.println( "' />");
        webui_client.println("<br />");
         webui_client.print("<label for='nthe'>NIGHTMODE STOP MODE </label>");webui_client.println("<input type='text' id='nthe' name='nthe' placeholder='0-23' value='");webui_client.print( nthe);webui_client.println( "' />");
        webui_client.print("<br />");
        
        webui_client.print("<label for='nthr'>NIGHTMODE ON COLOR [RGB] </label>");webui_client.println("<input type='text' id='nthr' name='nthr' placeholder='0-255'maxlength='3' size='5' value='");webui_client.print( nthr);webui_client.println( "' />");
        webui_client.println("<input type='text' id='nthg' name='nthg'maxlength='3' size='5' placeholder='0-255' value='");webui_client.print( nthg);webui_client.println( "' />");
        webui_client.println("<input type='text' id='nthb' name='nthb'maxlength='3' size='5' placeholder='0-255' value='");webui_client.print( nthb);webui_client.println( "' />");
        webui_client.println("<br />");
         webui_client.print("<label for='nthr'>NIGHTMODE OFF COLOR [RGB] </label>");webui_client.println("<input type='text' maxlength='5' size='5' id='nthr' name='nthzr' placeholder='0-255' value='");webui_client.print( nthzr);webui_client.println( "' />");
        webui_client.println("<input type='text' id='nthzg' maxlength='3' size='5' name='nthzg' placeholder='0-255' value='");webui_client.print( nthzg);webui_client.println( "' />");
        webui_client.println("<input type='text' id='nthzb' maxlength='3' size='5' name='nthzb' placeholder='0-255' value='");webui_client.print( nthzb);webui_client.println( "' />");
 
    webui_client.print("<br />");
       webui_client.print("<br />");
 
       
       webui_client.println("<input type='submit' value='Abschicken' />");
    webui_client.println("</form>");
         webui_client.println("<form id='ipsettings' name='ipsettings' action=''>"); 
       
          webui_client.println("<br />");
  webui_client.println("<hr />");webui_client.println("<H2>NTP-SETTINGS</H2> ");
         webui_client.println("<br />");  webui_client.println("<br />");
        webui_client.print("<label for='nthr'>TIMESERVER-IP [0-255] </label>");
        webui_client.println("<input type='text' maxlength='5' size='5' id='ntp0' name='ntp0' placeholder='0-255' value='");webui_client.print( timeServer[0], DEC);webui_client.println( "' />");
        webui_client.println("<input type='text' id='ntp1' maxlength='3' size='5' name='ntp1' placeholder='0-255' value='");webui_client.print( timeServer[1], DEC);webui_client.println( "' />");
        webui_client.println("<input type='text' id='ntp2' maxlength='3' size='5' name='ntp2' placeholder='0-255' value='");webui_client.print( timeServer[2], DEC);webui_client.println( "' />");
        webui_client.println("<input type='text' id='ntp3' maxlength='3' size='5' name='ntp3' placeholder='0-255' value='");webui_client.print( timeServer[3], DEC);webui_client.println( "' />");
  ...
  webui_client.print("<br />");
   webui_client.println("<br />");
  webui_client.println("<hr />");webui_client.println("<H2>INFORMATION</H2> ");
  webui_client.print("<br />");
 webui_client.print("<br />"); 
  ...
  webui_client.println("IP :"); for (byte thisByte = 0; thisByte < 4; thisByte++) {webui_client.print(ip[thisByte], DEC);if(thisByte < 3){ webui_client.print("."); }}  webui_client.println("<br />"); 
  webui_client.println("SUBNET :"); for (byte thisByte = 0; thisByte < 4; thisByte++) {webui_client.print(subnet[thisByte], DEC);if(thisByte < 3){ webui_client.print("."); }}  webui_client.println("<br />"); 
  webui_client.println("GATEWAY :"); for (byte thisByte = 0; thisByte < 4; thisByte++) {webui_client.print(gateway[thisByte], DEC);if(thisByte < 3){ webui_client.print("."); }}  webui_client.println("<br />");
  webui_client.println("MAC :"); for (byte thisByte = 0; thisByte < 6; thisByte++) {webui_client.print(mac[thisByte], HEX);if(thisByte < 5){ webui_client.print(":"); }} webui_client.println("<br />");
  webui_client.println("SOFTWARE VERSION :"); webui_client.print(software_version);  webui_client.println("<br />");
          ...
          webui_client.stop();
           ...
           if(readString.indexOf("?update_time") >0){get_ntp_time();save_settings(); }
           if(readString.indexOf("?nthen_toggle") >0){if(nthen == 1){nthen = 0;}else{nthen = 1;}save_settings();}
           if(readString.indexOf("?auto_refresh_toggle") >0){if(webui_auto_refresh == 1){webui_auto_refresh = 0;}else{webui_auto_refresh = 1;}save_settings();} 
           if(readString.indexOf("?toggle_dhcp") >0){if(enable_dhcp == 1){enable_dhcp = 0;}else{enable_dhcp = 1;}save_settings();} 
           if(readString.indexOf("?toggle_alarm") >0){if(alarm_en == 1){alarm_en = 0;}else{alarm_en = 1;}save_settings();} 
           if(readString.indexOf("?stop_alarm") >0){stop_alarm();} 
           if(readString.indexOf("?toggle_alarmbtn") >0){if(alarm_button_enable == 1){alarm_button_enable = 0;}else{alarm_button_enable = 1;}save_settings();} 
           
          
           
           
           if(readString.indexOf("&") >0){
           String split = readString;
      
          //11
          
          for (int index = 0; index < 15; index++) { 
      String word3 = getValue(split, '&', index);
          
          
          String word_param = getValue(word3, '=', 0);
          String word_result = getValue(word3, '=', 1);
          Serial.print(word_param);Serial.print("--------");Serial.println(word_result);
          int word_value = word_result.toInt();
          
          if(word_param == "alarm_h"){if(word_value > 23){word_value = 23;}if(word_result < 0){word_value = 0;}alarm_h = word_value; Serial.print("alarm_h:");Serial.print(alarm_h);save_settings();}
          else if(word_param == "alarm_m"){if(word_value > 59){word_value = 59;}if(word_result < 0){word_value = 0;}alarm_m = word_value; Serial.println("alarm_m:");Serial.print(alarm_m);save_settings();}
         
         
           else if(word_param == "nth"){if(word_value > 23){word_value = 23;}if(word_result < 0){word_value = 0;}nth = word_value; Serial.println("nth:");Serial.print(alarm_m);save_settings();}
           else if(word_param == "nthe"){if(word_value > 23){word_value = 23;}if(word_result < 0){word_value = 0;}nthe = word_value; Serial.println("alanthe:");Serial.print(alarm_m);save_settings();}
           else if(word_param == "GET /?zz"){if(word_value > 23){word_value = 23;}if(word_result < 0){word_value = 0;}zeitverschiebung = word_value; Serial.println("zeitverschiebung:");Serial.print(zeitverschiebung);save_settings();}
           
           else if(word_param == "nthr"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}nthr = word_value; Serial.println("nthr:");Serial.print(nthr);save_settings();}
           else if(word_param == "nthg"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}nthg = word_value; Serial.println("nthg:");Serial.print(nthg);save_settings();}
           else if(word_param == "nthb"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}nthb = word_value; Serial.println("nthb:");Serial.print(nthb);save_settings();}
           
           else if(word_param == "nthzr"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}nthzr = word_value; Serial.println("nthzr:");Serial.print(nthzr);save_settings();}
           else if(word_param == "nthzg"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}nthzg = word_value; Serial.println("nthzg:");Serial.print(nthzg);save_settings();}
           else if(word_param == "nthzb"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}nthzb = word_value; Serial.println("nthzb:");Serial.print(nthzb);save_settings();}
           
           else if(word_param == "GET /?ntp0"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}timeServer[0] = word_value; Serial.println("ntp0:");Serial.print(timeServer[0]);save_settings();}
           else if(word_param == "ntp1"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}timeServer[1] = word_value; Serial.println("ntp1:");Serial.print(timeServer[1]);save_settings();}
           else if(word_param == "ntp2"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}timeServer[2] = word_value; Serial.println("ntp2:");Serial.print(timeServer[2]);save_settings();}
           else if(word_param == "ntp3"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}timeServer[3] = word_value; Serial.println("ntp3:");Serial.print(timeServer[3]);save_settings();}
           
           else if(word_param == "GET /?ip0"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}ip[0] = word_value; Serial.println("ntp0:");Serial.print(ip[0]);save_settings();}
           else if(word_param == "ip1"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}ip[1] = word_value; Serial.println("ntp1:");Serial.print(ip[1]);save_settings();}
           else if(word_param == "ip2"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}ip[2] = word_value; Serial.println("ntp2:");Serial.print(ip[2]);save_settings();}
           else if(word_param == "ip3"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}ip[3] = word_value; Serial.println("ntp3:");Serial.print(ip[3]);save_settings();}
           
           else if(word_param == "GET /?subnet0"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}subnet[0] = word_value; Serial.println("subnet0:");Serial.print(subnet[0]);save_settings();}
           else if(word_param == "subnet1"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}subnet[1] = word_value; Serial.println("subnet1:");Serial.print(subnet[1]);save_settings();}
           else if(word_param == "subnet2"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}subnet[2] = word_value; Serial.println("subnet2:");Serial.print(subnet[2]);save_settings();}
           else if(word_param == "subnet3"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}subnet[3] = word_value; Serial.println("subnet3:");Serial.print(subnet[3]);save_settings();}
           
           else if(word_param == "GET /?gateway0"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}gateway[0] = word_value; Serial.println("gateway:");Serial.print(gateway[0]);save_settings();}
           else if(word_param == "gateway1"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}gateway[1] = word_value; Serial.println("gateway:");Serial.print(gateway[1]);save_settings();}
           else if(word_param == "gateway2"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}gateway[2] = word_value; Serial.println("gateway:");Serial.print(gateway[2]);save_settings();}
           else if(word_param == "gateway3"){if(word_value > 255){word_value = 255;}if(word_result < 0){word_value = 0;}gateway[3] = word_value; Serial.println("gateway:");Serial.print(gateway[3]);save_settings();}
...
EEPROM.write(7,webui_auto_refresh); //NT
...
void load_settings(){
   Serial.println("READ ALL SETTINGS TO EEPROM"); 
     ...
     webui_auto_refresh = EEPROM.read(7);
...
Serial.println("START NTP REQUEST");
  ...
  Serial.print("CHANGE MODE : "); Serial.println(ledmode); 
   ...
   }else if( digitalRead(sw1) == HIGH && digitalRead(sw2) == HIGH && digitalRead(sw3) == HIGH && prev_state_button == 0 && alarm_button_enable == 1){ 
  //Serial.print("CHANGE MODE : "); Serial.println(ledmode); 
   prev_state_button = 1;
   stop_alarm();
